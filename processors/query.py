...
- "We just signed X", "just closed X", "new signed account X", "schedule the buyer's story for X", "log the X signing" → use schedule_buyer_story. This queues the post-signing interview follow-up to surface in the brief 14 days out. Do NOT use add_capture for a new signing.
